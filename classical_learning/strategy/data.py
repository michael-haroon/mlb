...
_PREGAME_FEATURE_PREFIXES = (
    ...
    # Team batting rolling features (batted ball quality, spray, platoon composition)
    "home_bat_", "away_bat_",
    ...
    "home_div_", "away_div_",
    "home_wc_", "away_wc_",
    "home_in_contention", "away_in_contention",
    "season_progress",
    "diff_div",
...
# Broader than exact-name exclusions to catch all box-score aggregates.
_POSTGAME_EXCLUSION_PREFIXES = (
    "home_bat_game_", "away_bat_game_",   # game A batting box score
    "home_pit_game_", "away_pit_game_",   # game A pitching box score
    "sp_home_game_", "sp_away_game_",     # SP stats from THIS game
    "home_bat_players_", "away_bat_players_",  # player count (postgame)
    "home_pit_players_", "away_pit_players_",
)
