...
```python
# Conceptual ingestion layer (to be implemented in deep_learning/mlb_dl/ingestion.py)
...
```python
# deep_learning/mlb_dl/tests/test_inference_engine.py
...
- [ ] Checkpoint best model to `deep_learning/mlb_dl/checkpoints/`
