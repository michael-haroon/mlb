...
**Flow invariants:**
- All data passes through validation gate before model ingestion (see `/Users/michaelharoon/Projects/prediction_markets/mlb/live/mlb_dl/validation_gate.py`)
...
**Empirical validation on MLB data (from `pregame/gemini_research.md`):**
...
**Code location:** Ingestion logic implemented in `/Users/michaelharoon/Projects/prediction_markets/mlb/live/mlb_dl/data_sources.py` (TODO: validate file exists and implements WebSocket client)
...
**Implementation:** `/Users/michaelharoon/Projects/prediction_markets/mlb/live/mlb_dl/validation_gate.py` (see Task 2 below)
...
- Generated by pregame module's final MLP layer: `/Users/michaelharoon/Projects/prediction_markets/mlb/pregame/engineering/features.py` → rating system → MLP → 256-dim embedding
...
| 5/9 scaling for first-5 innings is uniform | Empirical | Validated in `pregame/gemini_research.md`; assumes no systematic early-game bias |
