...
This package is the first production-oriented slice of the MLB modeling system.
It deliberately starts with a leakage-aware pre-game model and a reusable target
builder before adding live pitch-by-pitch models.
