...
**Status**: Infrastructure complete (2026-07-09)  
**Next**: Model training + ingestion layer + runner integration
...
**File**: `pregame/trading/runner.py`

**Tasks**:
- [ ] Add `_live_bridge` field to `TradingRunner.__init__`
- [ ] Start bridge in `TradingRunner.start()`
  - [ ] Load model checkpoint from `live/mlb_dl/checkpoints/best_model.pt`
...
**File**: `live/mlb_dl/distributions.py` (already exists)
...
**File**: `live/mlb_dl/inference_engine.py`
...
**File**: `live/mlb_dl/feature_cache.py` (new)
...
**File**: `live/mlb_dl/dashboard.py` (new, optional)
...
**File**: `pregame/trading/analytics/pnl_attribution.py`
...
**For questions on**:
- Model architecture → Check `live/mlb_dl/models.py` + `INFERENCE_ENGINE_README.md`
